...
HD_PWD='D:/ECE385/Lab4/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Miltiplier_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Miltiplier_top.tcl -notrace
