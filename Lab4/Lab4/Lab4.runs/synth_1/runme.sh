...
HD_PWD='D:/ECE385/Lab4/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Miltiplier_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Miltiplier_top.tcl
