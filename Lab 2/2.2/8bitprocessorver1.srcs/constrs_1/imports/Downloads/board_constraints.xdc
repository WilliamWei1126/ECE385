...
## Push buttons
set_property PACKAGE_PIN A4 [get_ports {F[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {F[0]}]

set_property PACKAGE_PIN A5 [get_ports {F[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {F[1]}]

set_property PACKAGE_PIN A6 [get_ports {F[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {F[2]}]

set_property PACKAGE_PIN A8 [get_ports {F[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {F[3]}]

set_property PACKAGE_PIN G7 [get_ports {R[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {R[0]}]

set_property PACKAGE_PIN J1 [get_ports {Key[1]}]
...
set_property PACKAGE_PIN D14 [get_ports {Bval[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Bval[1]}]

set_property PACKAGE_PIN D15 [get_ports {Bval[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Bval[2]}]

set_property PACKAGE_PIN E16 [get_ports {Bval[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Bval[3]}]

set_property PACKAGE_PIN F17 [get_ports {Bval[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Bval[4]}]

set_property PACKAGE_PIN E17 [get_ports {Bval[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Bval[5]}]

set_property PACKAGE_PIN D17 [get_ports {Bval[6]}]
...
set_property PACKAGE_PIN A18 [get_ports {Aval[6]}]
